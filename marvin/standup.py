...
class Standup(Response):
    ...
    def pre_standup(self):
        ...
        for name, uid in users.items():
            msg = self.say(f'Hi {name}! What updates do you have for the team today? Please respond by threading to this message and remember: your response will be shared!',
